...
describe('Vigenère cipher - encryption', () => {
  test('Basic', () => {
    ...
    expect(encrypt('abcdefghijklmnopqrstuvwxyz', {key: 'cowabunga'})).toEqual(
      'cpydfztnilyhmoicwruhqvxrlf'
    );
    expect(encrypt('this is my secret message', {key: 'secretkey'})).toEqual(
...
describe('Vigenère cipher - decryption', () => {
  test('Basic', () => {
    ...
    expect(decrypt('cpydfztnilyhmoicwruhqvxrlf', {key: 'cowabunga'})).toEqual(
      'abcdefghijklmnopqrstuvwxyz'
    );
    expect(decrypt('llkj ml wc qwgtvx fowqskg', {key: 'secretkey'})).toEqual(
